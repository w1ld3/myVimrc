...
Plugin 'kien/ctrlp.vim'  "在buffer中快速查文件 Ctrl + P
...
" 不确认、整词
nnoremap <Leader>rrw :call Replace(0, 1, input('Replace '.expand('<cword>').' with: '))<CR>
" 确认、非整词
